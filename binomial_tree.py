...
def spy_data_df():
    spy_data_raw = pd.read_excel('https://raw.githubusercontent.com/sambrazer/Binomial-Tree-Model/master/SPY.csv')
    tbill_data = pd.read_excel('https://raw.githubusercontent.com/sambrazer/Binomial-Tree-Model/master/Tbill.csv')
...
def current_valuation(value_date):
    '''Imports SPY data and 3 Month TBill data'''
    spy_data_raw = pd.read_excel(r'C:\Users\sambr\Documents\Personal\Investments\Trading Strategies\Derivatives Sheets\SPY Work\Binomial Sim - 2.xlsx')
    tbill_data = pd.read_excel(r'C:\Users\sambr\Documents\Personal\Investments\Trading Strategies\Derivatives Sheets\SPY Work\Binomial Sim - 2.xlsx', '3 month T-Bill')
    tbill_data = tbill_data.rename(columns = {'Close': 'RF'})
